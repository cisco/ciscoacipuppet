...
#
# Base (create, modify, delete) acceptance test for fvtenant
#
...
describe 'fvtenant' do
  context 'Base acceptance test' do
    basedata_fname = File.dirname(__FILE__) + '/fvtenant_basedata.pp'
    basedata = File.read(basedata_fname)
    it 'fvtenant Testcase Setup' do
