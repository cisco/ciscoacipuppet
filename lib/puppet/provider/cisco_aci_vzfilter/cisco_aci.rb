...
Puppet::Type.type(:cisco_aci_vzfilter).provide(:cisco_aci) do
  desc 'The Cisco provider for vzfilter.'
  ...
  def self.prefetch(resources)
    vzfilter_instances = instances
    resources.keys.each do |name|
      provider = vzfilter_instances.find do |inst|
